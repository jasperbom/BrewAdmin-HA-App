...
export const excelExport = (
  ...
  bestellingen?: any, bestellingPicks?: any, afboekingen?: any
) => {
  ...
  [
    ...
    ['VerkoopFacturen', verkoopFacturen || []], ['Bestellingen', bestellingen || []],
    ['BestellingPicks', bestellingPicks || []], ['Afboekingen', afboekingen || []]
...
export const excelImport = (file: File, cb: (data: any) => void) => {
  ...
  r.onload = e => {
    ...
    cb({
      ...
      bestellingen: parse('Bestellingen'), bestellingPicks: parse('BestellingPicks'),
