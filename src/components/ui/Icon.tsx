...
const PADEN: Record<string, string> = {
  ...
  snowflake:   'M12 2v20 M3.3 7l17.4 10 M3.3 17l17.4-10 M9 3.5l3 2 3-2 M9 20.5l3-2 3 2 M3.6 10.2l2.9-1.4-.3-3.2 M20.4 13.8l-2.9 1.4.3 3.2 M3.6 13.8l2.9 1.4-.3 3.2 M20.4 10.2l-2.9-1.4.3-3.2',
  ...
  // Schil: rail, onderbalk, kopbalk en de Meer-pagina.
  ...
  wifiOff:     'M2 2l20 20 M8.5 16.5a5 5 0 017 0 M5 12.5a10 10 0 015.2-2.7 M1.5 9a15 15 0 015-3 M12 20h.01 M22.5 9a15 15 0 00-8.7-4.3 M19 12.5a10 10 0 00-3.5-2.2',
}
