...
// PDF helpers — pdfjs-dist wordt meegebundeld (voorheen werd op een nooit
// geladen window.pdfjsLib gewacht, waardoor de lokale PDF-parse dood was en
// elke factuur onnodig naar de Claude-API ging).
...
async function extractPdfText(file: File): Promise<string> {
  try {
    ...
    // een kwaadaardig PDF-font); facturen komen van externe leveranciers.
