  ...
  return (
    <div className="min-h-screen" style={{backgroundColor:'var(--t-bg)'}}>
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
        {page==='dashboard'    && <DashboardPage ing={ing} lots={lots} bat={bat} bi={bi} uit={uit} acc={acc} av={av} setPage={setPage} tanks={tanks} gistMetingen={gistMetingen} setGistMetingen={setGistMetingen} haInst={haInst} haTankTemps={haTankTemps} setNavBatchId={setNavBatchId} btwInst={btwInst} bankKoppelingen={bankKoppelingen} />}
